...
// WithUserSubscriptionCreateObject adds the userSubscriptionCreateObject to the get subscriptions params
func (o *GetSubscriptionsParams) WithUserSubscriptionCreateObject(userSubscriptionCreateObject *models.UserSubscriptionCreateObject) *GetSubscriptionsParams {
	o.SetUserSubscriptionCreateObject(userSubscriptionCreateObject)
	return o
}

// SetUserSubscriptionCreateObject adds the userSubscriptionCreateObject to the get subscriptions params
func (o *GetSubscriptionsParams) SetUserSubscriptionCreateObject(userSubscriptionCreateObject *models.UserSubscriptionCreateObject) {
