...
// WithAppID adds the appID to the delete version params
func (o *DeleteVersionParams) WithAppID(appID string) *DeleteVersionParams {
	o.SetAppID(appID)
	return o
}

// SetAppID adds the appId to the delete version params
func (o *DeleteVersionParams) SetAppID(appID string) {
	o.AppID = appID
}
