...
// WithAppID adds the appID to the get endpoints params
func (o *GetEndpointsParams) WithAppID(appID string) *GetEndpointsParams {
	o.SetAppID(appID)
	return o
}

// SetAppID adds the appId to the get endpoints params
func (o *GetEndpointsParams) SetAppID(appID string) {
	o.AppID = appID
}
